...
class StateController extends DocumentController
{
    ...
    public function get()
    {
        ...
        $data = $this->checkParams(
            $pattern, array('registration' => 'string'), $this->params
        );

        // use the DocumentController to handle document response
    ...
    public function store()
    {
        ...
        $data = $this->checkParams($pattern, array('registration' => 'string'), $this->params);
